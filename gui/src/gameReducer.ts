import { bounceAsteroids, checkWin, createNewBullets, createRandomAsteroid, destructAsteroids, destructSpaceship, evolveAsteroids, evolveBullets, evolveSpaceship } from "./helpers";
    ...
    switch (action.type) {
      ...
      case "fireBullet": {
        ...
        if (newBullets.length > maxNumActiveBullets - numExistingBullets) {
          newBullets = newBullets.slice(0, maxNumActiveBullets - numExistingBullets);
        }
